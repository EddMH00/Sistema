...
def ver_tabla_mysql():
    # Con el administrador de contexto, la conexión se maneja automáticamente
    with MySQLManager(host='localhost', user='root', password='Mollejas2<', database='proyecto') as manager:
        if not manager:
        ...
        try:
            ...
            for fila in resultados:
                print(f"{fila[0]:<10}{fila[1]:<20}{fila[2]:<20}{fila[3]:<20}"
                      f"{fila[7]:<15}{fila[6]:<20}{fila[8]:<20}")
